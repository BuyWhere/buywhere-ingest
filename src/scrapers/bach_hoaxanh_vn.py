"""Scraper for Bách hoá XANH Vietnam grocery products."""
...
_SCRIPT = Path(__file__).resolve().parents[2] / "scripts" / "ingest_bach_hoaxanh_vn.py"


class BachHoaXanhVNScraper(BaseScraper):
    """Scraper for Bách hoá XANH Vietnam."""

    def __init__(self, max_products: int = 500):
        super().__init__("Bach Hoa Xanh VN", "https://www.bachhoaxanh.com")
