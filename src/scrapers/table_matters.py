"""Scraper for Table Matters Singapore."""

from typing import List
from .base_scraper import BaseScraper, Product

TABLE_MATTERS_BASE = "https://www.tablematters.com"


class TableMattersScraper(BaseScraper):
    def __init__(self):
        super().__init__("Table Matters", TABLE_MATTERS_BASE)
