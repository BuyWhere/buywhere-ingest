"""Scraper for Outdoor Life Singapore."""

from typing import List
from .base_scraper import BaseScraper, Product

OUTDOOR_LIFE_SG_BASE = "https://www.outdoorlife.com.sg"


class OutdoorLifeSGScraper(BaseScraper):
    def __init__(self):
        super().__init__("Outdoor Life SG", OUTDOOR_LIFE_SG_BASE)
