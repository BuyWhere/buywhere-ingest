"""Scraper for The Editor's Market Singapore."""

from typing import List
from .base_scraper import BaseScraper, Product

EDITORS_MARKET_BASE = "https://www.editorsmarket.com"


class EditorsMarketScraper(BaseScraper):
    def __init__(self):
        super().__init__("The Editor's Market", EDITORS_MARKET_BASE)
