"""Scraper for Cold Storage Singapore."""

from typing import List
from .base_scraper import BaseScraper, Product

COLD_STORAGE_SG_BASE = "https://www.coldstorage.com.sg"


class ColdStorageSGScraper(BaseScraper):
    def __init__(self):
        super().__init__("Cold Storage SG", COLD_STORAGE_SG_BASE)
