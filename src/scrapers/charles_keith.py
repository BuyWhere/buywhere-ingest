"""Scraper for Charles & Keith Singapore."""

from typing import List
from .base_scraper import BaseScraper, Product

CHARLES_KIETH_BASE = "https://www.charleskeith.com/sg"


class CharlesKeithScraper(BaseScraper):
    def __init__(self):
        super().__init__("Charles & Keith", CHARLES_KIETH_BASE)
