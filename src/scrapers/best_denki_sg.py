"""Scraper for Best Denki Singapore."""

from typing import List
from .base_scraper import BaseScraper, Product

BEST_DENKI_SG_BASE = "https://www.bestdenki.com.sg"


class BestDenkiSGScraper(BaseScraper):
    def __init__(self):
        super().__init__("Best Denki SG", BEST_DENKI_SG_BASE)
