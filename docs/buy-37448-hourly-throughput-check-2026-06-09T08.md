# BUY-37448 — Hourly throughput check (2026-06-09 09:06 UTC fire, 08:00–09:00 UTC window)

**Result: PASS — 450,943 / 150,000 (300.6% of threshold; +300,943 above bar). No failure child was filed under [BUY-29861](/BUY/issues/BUY-29861).**
...
| Metric | Value |
|---|---:|
| Hour checked | `2026-06-09T08:00:00+00:00 -> 2026-06-09T09:00:00+00:00` |
| Throughput signal | `n_tup_ins_delta` |
| Real rows | `450,943` |
| Threshold | `150,000` |
| Margin vs threshold | `+300,943` |
| Percent of target | `300.6%` |
| Prior baseline `n_tup_ins` | `20,532,918 @ 2026-06-09T08:04:42.260056+00:00` |
| Current sample `n_tup_ins` | `20,996,479 @ 2026-06-09T09:06:22.989025+00:00` |
| Current `n_live_tup` | `57,474,285` |
...
```text
[throughput-dispatcher] Checking hour 2026-06-09T08:00:00+00:00 → 2026-06-09T09:00:00+00:00
...
[throughput-dispatcher] real_rows=450,943 target=150,000 (300.6%) source=n_tup_ins_delta
[throughput-dispatcher] PASS — 450,943 >= 150,000. No issue filed.
```
...
```json
{
  "last_n_tup_ins": 20996479,
  "last_n_tup_ins_at": "2026-06-09T09:06:22.989025+00:00",
  "last_hour_checked": "2026-06-09T08:00:00+00:00",
  "last_check_result": "PASS",
  "last_check_real_rows": 450943,
  "last_check_source": "n_tup_ins_delta",
  "last_n_live_tup": 57474285,
