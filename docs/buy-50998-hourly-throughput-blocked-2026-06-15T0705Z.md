# BUY-50998 — Hourly throughput check blocked (2026-06-15 07:05 UTC)

## Summary

The standard hourly throughput dispatcher could not evaluate the just-completed
`2026-06-15 06:00–07:00 UTC` window because the canonical maglev catalog
endpoint in `data/.catalog_db_url` is still serving PostgreSQL in recovery
mode.
...
- Fire time: `2026-06-15T07:05:00Z`
- Target hour: `2026-06-15 06:00–07:00 UTC`
- Existing unblock owner issue: [BUY-50740](/BUY/issues/BUY-50740)

Observed failure:

```text
[throughput-dispatcher] Checking hour 2026-06-15T06:00:00+00:00 → 2026-06-15T07:00:00+00:00
...
- No canonical PostgreSQL measurement is available for the `06:00–07:00 UTC`
  hour.
...
- Action: restore the production catalog endpoint behind `data/.catalog_db_url`
  so it no longer returns recovery mode, then rerun BUY-50998 for the
  `2026-06-15 06:00–07:00 UTC` window.
