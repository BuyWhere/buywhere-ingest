# BUY-8032: Cohort 2 AI-Agent Developer Leads (First 10)

Date checked: 2026-05-29 UTC

Method:
- Pulled active and documented AI-agent developer ecosystems from official docs and open-source project pages.
- Kept only leads with clear developer entry points (public docs, GitHub/SDK access, integration surfaces, and community presence).

Qualified external AI-agent developer leads:

| # | Lead / Ecosystem | Source signal | Why it qualifies |
| --- | --- | --- | --- |
...
| 8 | Google Agent Development Kit (ADK) (`google/adk-python`) | `adk.dev`, `github.com/google/adk-python` | Production-oriented open-source toolkit focused on code-first agent development and deployment. |
