# BUY-51369 — Hourly throughput check blocked (2026-06-15 12:03:24 UTC)

## Summary

The standard hourly throughput dispatcher could not evaluate the just-completed
`2026-06-15 11:00–12:00 UTC` window because the canonical maglev catalog
...
- Fire time: `2026-06-15T12:03:24Z`
- Target hour: `2026-06-15 11:00–12:00 UTC`
- Existing unblock owner issue: [BUY-50740](/BUY/issues/BUY-50740)

Observed failure:

```text
[throughput-dispatcher] Checking hour 2026-06-15T11:00:00+00:00 → 2026-06-15T12:00:00+00:00
...
- No canonical PostgreSQL measurement is available for the `11:00–12:00 UTC`
  hour.
...
- Action: restore the production catalog endpoint behind `data/.catalog_db_url`
  so it accepts normal connections again, then rerun BUY-51369 for the
  `2026-06-15 11:00–12:00 UTC` window.
